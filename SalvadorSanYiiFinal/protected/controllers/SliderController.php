...
class SliderController extends Controller
{
	...
	public function actionDelete($id)
	{
		...
		$this->redirect(Yii::app()->baseUrl.'/index.php?r=slider/index');
	}
	...
	public function actionUpload() {
		Yii::import("ext.EAjaxUploadSlider.qqFileUploader");
	
		$folder = 'themes/hebo/img/slider/'; // folder for uploaded files
